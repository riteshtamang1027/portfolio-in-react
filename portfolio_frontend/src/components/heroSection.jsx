...
export default function heroSection() {
  return (
    <div className="xl:px-64 lg:px-32 md:px-16 px-4 sm:px-32 max-md:mt-4 text-white h-full">
      {/* main div */}
      <div className="md:relative border border-cyan-600 px-4 py-4 md:top-1/2 md:transform md:-translate-y-1/2 bg-[linear-gradient(to_left,var(--custom-a0),var(--custom-a10),var(--custom-a20),var(--custom-a30),var(--custom-a40))] rounded-2xl shadow-2xl space-y-8">
        {/* Header section */}
        <p className="text-white lg:text-3xl md:text-2xl text-3xl font-bold">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full  xl:gap-16 gap-4 py-2 sm:px-4">
          ...
          <div className="md:w-2/3 space-y-8 md:order-1 order-2 max-md:text-center  py-2  max-md:px-4">
            {/* text section */}
            <div className="text-base space-y-2 md:space-y-4 ">
          ...
          <div className="md:w-1/3   overflow-hidden  order-1 md:order-2">
