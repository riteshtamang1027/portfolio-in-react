...
{/* This is the actual div where you can edit your profile's elements */}
      {Isopen && (
        <form onSubmit={handleSubmit} className="md:w-100 w-max max-h-[90vh] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-gray-200 rounded-xl  overflow-y-auto scroll-smooth hide-scrollbar">
          ...
          <div className="px-8 py-4 space-y-8 ">
           ...
           <div className="relative w-full   py-4">
            ...
            <input type="file" onChange={(e)=>setImg(e.target.files[0])} name="" id="imageUpload" className="hidden" accept="image/*" />

{/* when you click this section you pushout to your device files section. */}
            <label htmlFor="imageUpload"  className="p-2 bg-gray-300 rounded-full w-max absolute transform left-2/3 bottom-6 cursor-pointer">
